...
export const SUPANEXUS_SETTINGS_NS = 'supanexus';
/** Field that controls sidebar balance visibility. */
export const SHOW_WALLET_FIELD = 'showWallet';
/** Field that controls SupaNexus brand chrome (sidebar + hero + tab). */
export const SHOW_BRAND_FIELD = 'showBrand';
/** Field that pins the platform region (`global` | `cn`). */
export const PINNED_LINE_FIELD = 'pinnedLine';
