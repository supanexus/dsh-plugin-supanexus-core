...
import { FooterErrorBoundary } from "./FooterErrorBoundary.js";
...
export function SidebarFooterRoot(props) {
    ...
    return (_jsxs("div", { className: css.stack, children: [_jsx(FooterErrorBoundary, { label: "wallet", children: _jsx(WalletRoot, { ...rest, settings: settings }) }), _jsx(FooterErrorBoundary, { label: "skill-market", children: _jsx(SkillMarketRoot, { ...rest, settings: settings }) })] }));
}
