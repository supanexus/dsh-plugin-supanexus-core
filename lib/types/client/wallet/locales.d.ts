...
declare const zh: {
    ...
    readonly close: "关闭";
    readonly tabAccount: "账户";
    readonly tabSubscription: "订阅";
    readonly balanceLabel: "可用余额";
    readonly pointsLabel: "剩余积分";
    readonly pointsGrantedLabel: "本周期额度";
    readonly planLabel: "订阅档位";
    readonly subscriptionStatusLabel: "订阅状态";
    readonly noPlan: "无订阅";
    readonly orgLabel: "组织";
    readonly resetAtLabel: "下次积分重置";
    readonly periodEndLabel: "周期结束";
    readonly refresh: "刷新";
    ...
    readonly keyMismatchHint: "API Key 已变更，请打开设置 → 模型，重新执行 SupaNexus 快速配置。";
    readonly reconfigureNeeded: "需重新配置";
