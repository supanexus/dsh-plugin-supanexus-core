...
export function patchDocumentProductTitle() {
...
export function patchFavicon() {
    const links = document.querySelectorAll('link[rel="icon"], link[rel="shortcut icon"]');
    if (links.length === 0) {
        if (capturedFaviconHref === undefined)
            capturedFaviconHref = '';
...
export function watchTabBrandingPatches() {
...
//# sourceMappingURL=patchShellBranding.js.map