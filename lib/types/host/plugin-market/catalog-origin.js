 ...
 */
export function resolvePluginCatalogOrigin(config, line) {
    const fromLine = line.pluginCatalogOrigin?.trim() ?? '';
    if (fromLine.length > 0)
        return normalizeOrigin(fromLine);
 ...
 */
export function resolveConsoleOrigin(config, line) {
...
//# sourceMappingURL=catalog-origin.js.map