...
function resolveRequestHostname(request) {
    ...
    if (urlHost !== INTERNAL_BRIDGE_HOST)
        return urlHost;
...
export function respawnInvocation(launch, platform = nodeProcess().platform) {
    if (platform !== 'win32') {
        return {
            file: launch.file,
            args: launch.args,
 ...
 */
export function scheduleHostRelaunch(kill = (pid, signal) => {
...
//# sourceMappingURL=restart-host.js.map