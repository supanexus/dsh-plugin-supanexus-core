	...
	factory: (require) => {
		...
		*/
		...
		function SupaNexusBrandNameSlot({ ctx }) {
			return (0, react_jsx_runtime.jsx)(SupaNexusBrandName, { locale: useClientLocale(ctx) });
		}
		//#endregion
		...
		*/
		...
		const WALLET_TRIGGER_ROTATE_MS = 4e3;
		//#endregion
		...
		function formatWalletTriggerAria(labels, locale) {
			if (!labels.canRotate || labels.pointsLabel === void 0) return labels.balanceLabel;
			return `${locale?.startsWith("zh") ? "余额" : "Balance"} ${labels.balanceLabel} · ${labels.pointsLabel}`;
		}
		/** Format unix seconds for panel secondary rows; empty when unset. */
		function formatWalletUnixDate(unixSeconds, locale) {
			if (unixSeconds === null || unixSeconds === void 0) return void 0;
			if (!Number.isFinite(unixSeconds) || unixSeconds <= 0) return void 0;
			try {
				return (/* @__PURE__ */ new Date(unixSeconds * 1e3)).toLocaleString(locale?.startsWith("zh") ? "zh-CN" : "en-US", {
					dateStyle: "medium",
					timeStyle: "short"
				});
			} catch {
		...
		*/
		...
		function normalizeWalletStatus(raw) {
			return {
				...
				...typeof raw.keyPrefix === "string" && raw.keyPrefix.length > 0 ? { keyPrefix: raw.keyPrefix } : {}
			};
		}
		/** Normalize Host balance payloads for older Host builds without points fields. */
		function normalizeWalletBalance(raw) {
			return {
				connected: true,
		...
		async function fetchWalletStatus() {
			...
			return normalizeWalletStatus(await parseJson(await fetch(url)));
		}
		...
		async function fetchWalletBalance(locale) {
			...
			if (locale !== void 0 && locale.length > 0) url.searchParams.set("locale", locale);
			return normalizeWalletBalance(await parseJson(await fetch(url)));
		}
		//#endregion
		...
		var wallet_module_css_default = {
			...
			"balanceSecondary": "HtX0mG_balanceSecondary",
			...
			"panel": "HtX0mG_panel",
			"rail": "HtX0mG_rail",
			"segmentButton": "HtX0mG_segmentButton",
			"segmentButtonActive": "HtX0mG_segmentButtonActive",
			"segmentGroup": "HtX0mG_segmentGroup",
			"status": "HtX0mG_status",
			"tabBar": "HtX0mG_tabBar",
			"title": "HtX0mG_title",
			"trigger": "HtX0mG_trigger",
			"triggerFade": "HtX0mG_triggerFade",
			"triggerLabel": "HtX0mG_triggerLabel",
			"walletTriggerFade": "HtX0mG_walletTriggerFade"
		};
		//#endregion
		...
		function WalletPanel({ locale, onClose, onBalanceChange }) {
			...
			const resetAt = data === void 0 ? void 0 : formatWalletUnixDate(data.nextPointsResetAtUnix, locale);
			const periodEnd = data === void 0 ? void 0 : formatWalletUnixDate(data.periodEndUnix, locale);
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					loading && data === void 0 && !credentialMismatch ? (0, react_jsx_runtime.jsx)("p", {
						className: wallet_module_css_default.status,
						children: t("loading")
					}) : null,
					data !== void 0 ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("div", {
						className: wallet_module_css_default.tabBar,
						children: (0, react_jsx_runtime.jsxs)("div", {
							className: wallet_module_css_default.segmentGroup,
							role: "tablist",
							"aria-label": t("title"),
							id: tabListId,
							children: [(0, react_jsx_runtime.jsx)("button", {
								...
								className: tab === "account" ? wallet_module_css_default.segmentButtonActive : wallet_module_css_default.segmentButton,
								onClick: () => {
									setTab("account");
								},
								...
								className: tab === "subscription" ? wallet_module_css_default.segmentButtonActive : wallet_module_css_default.segmentButton,
								onClick: () => {
									setTab("subscription");
								},
								children: t("tabSubscription")
							})]
						})
					}), tab === "account" ? (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							data.name.length > 0 ? (0, react_jsx_runtime.jsxs)("p", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("p", {
								className: wallet_module_css_default.balanceLabel,
								children: t("pointsLabel")
							}),
							(0, react_jsx_runtime.jsx)("p", {
								className: wallet_module_css_default.balanceValue,
								children: formatPointsRemaining(data.pointsRemaining, locale)
							}),
							data.pointsGranted.length > 0 && data.pointsGranted !== "0" ? (0, react_jsx_runtime.jsxs)("p", {
								className: wallet_module_css_default.orgRow,
								children: [
							...
							(0, react_jsx_runtime.jsx)("p", {
								className: wallet_module_css_default.balanceLabel,
								children: t("planLabel")
							}),
							(0, react_jsx_runtime.jsx)("p", {
								className: data.planName.length > 0 ? wallet_module_css_default.balanceSecondary : wallet_module_css_default.orgRow,
								children: data.planName.length > 0 ? data.planName : t("noPlan")
							}),
							data.subscriptionStatus.length > 0 ? (0, react_jsx_runtime.jsxs)("p", {
								className: wallet_module_css_default.orgRow,
								children: [
							...
							resetAt !== void 0 ? (0, react_jsx_runtime.jsxs)("p", {
								className: wallet_module_css_default.orgRow,
								children: [
									t("resetAtLabel"),
									": ",
							...
							periodEnd !== void 0 ? (0, react_jsx_runtime.jsxs)("p", {
								className: wallet_module_css_default.orgRow,
								children: [
									t("periodEndLabel"),
									": ",
					...
					error !== void 0 ? (0, react_jsx_runtime.jsx)("p", {
						className: softHint ? wallet_module_css_default.hint : wallet_module_css_default.error,
						children: error
					}) : (0, react_jsx_runtime.jsx)("p", {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("button", {
							...
							disabled: budgetUrl === void 0 || budgetUrl.length === 0 || credentialMismatch,
							onClick: openBudget,
		...
		*/
		function WalletRoot({ wide, ctx, settings }) {
			...
			const [credentialAligned, setCredentialAligned] = (0, react.useState)(true);
			const [labels, setLabels] = (0, react.useState)();
			const [showPoints, setShowPoints] = (0, react.useState)(true);
			const [open, setOpen] = (0, react.useState)(false);
			const titleId = (0, react.useId)();
			const close = (0, react.useCallback)(() => {
				setOpen(false);
			...
			const applyBalance = (0, react.useCallback)((balance) => {
				if (balance === void 0) {
					setLabels(void 0);
					return;
				}
			...
			const rotatingDisplay = labels?.canRotate && labels.pointsLabel !== void 0 ? showPoints ? labels.pointsLabel : labels.balanceLabel : labels?.balanceLabel;
			const display = mismatch ? t("reconfigureNeeded") : rotatingDisplay ?? t("nav");
			const ariaAmount = mismatch ? t("reconfigureNeeded") : labels === void 0 ? void 0 : formatWalletTriggerAria(labels, locale);
			const title = ariaAmount === void 0 ? `${t("nav")} — ${t("visibilityHint")}` : `${t("nav")} ${ariaAmount} — ${mismatch ? t("keyMismatchHint") : t("visibilityHint")}`;
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("button", {
					...
					children: [(0, react_jsx_runtime.jsx)(WalletIcon, { size: wide ? 16 : 18 }), wide && (0, react_jsx_runtime.jsx)("span", {
						className: `${wallet_module_css_default.triggerLabel} ${wallet_module_css_default.amountLabel} ${wallet_module_css_default.triggerFade}`,
						id: titleId,
						children: display
					}, display)]
				}), open && (0, react_jsx_runtime.jsxs)("div", {
		...
		//#endregion
		//#region lib/types/client/sidebar-footer/FooterErrorBoundary.js
		/**
		...
		*/
		var FooterErrorBoundary = class extends react.Component {
			state = { failed: false };
		...
		*/
		function SidebarFooterRoot(props) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsx)(FooterErrorBoundary, {
					label: "wallet",
					children: (0, react_jsx_runtime.jsx)(WalletRoot, {
						...rest,
						settings
					})
				}), (0, react_jsx_runtime.jsx)(FooterErrorBoundary, {
					label: "skill-market",
					children: (0, react_jsx_runtime.jsx)(SkillMarketRoot, {
						...rest,
						settings
					})
				})]
