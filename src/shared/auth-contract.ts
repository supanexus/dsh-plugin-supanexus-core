...
export const AUTH_START_PATH = '/api/supanexus.auth.start' as const
export const AUTH_STATUS_PATH = '/api/supanexus.auth.status' as const
...
export function apiOk<T>(data: T): T & { readonly ok: true } {
  return { ok: true as const, ...data }
}

export function apiErr(message: string, code?: string): ApiErrorResponse {
